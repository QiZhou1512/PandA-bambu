...
DesignFlowStep_Status top_entity::InternalExec()
{
   ...
   structural_objectRef andGateClockG = SM->add_module_from_technology_library("andGateClockG", AND_GATE_STD, HLS->HLS_T->get_technology_manager()->get_library(AND_GATE_STD), circuit, HLS->HLS_T->get_technology_manager());
